<%@ Page Title="" Language="C#" MasterPageFile="~/Panel.Master" AutoEventWireup="true" CodeBehind="Guncelle.aspx.cs" Inherits="CarSite.Ilanlarim.Guncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="Form1" runat="server" class="auto-style1">
        ...
        <div class="d-flex justify-content-center">
            <asp:Button ID="Btn_Ekle" runat="server" Text="Güncelle" CssClass="btn btn-warning w-100 text-white" OnClick="Btn_Ekle_Click" />
        </div>
